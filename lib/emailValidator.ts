...
const BLOCKED_DOMAINS = new Set([
  ...
  'spamfree.eu', 'trbvm.com', 'trbvn.com',
  ...
  'throwaway.email', 'throwaways.co.uk',
  ...
  'nospam4.us', 'nospammail.net',
  'obobbo.com',
  'plusplusemail.com', 'posteo.net',
  'privacypark.com',
  'tempr.email',
